...
l = this, a = function() {
    ...
    var e = (l.navigator || {}).userAgent,
        ...
        f = function() { try { return "production" === process.env.NODE_ENV } catch (l) { return !1 } }();
    var t = n || {};
    ...
    return function(l) { try { l() } catch (l) { if (!f) throw l } }(function() { var l; "function" == typeof i.hooks.addShims ? i.hooks.addShims(s) : (l = i.shims).push.apply(l, s) }), s
