! function() {
    ...
    function V(c, v) {
        var z = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks,
            h = void 0 !== z && z,
            l = Object.keys(v).reduce(function(c, z) { var h = v[z]; return !!h.icon ? c[h.iconName] = h.icon : c[z] = h, c }, {});
        "function" != typeof H.hooks.addPack || h ? H.styles[c] = function(l) {
            for (var c = 1; c < arguments.length; c++) {
                ...
                "function" == typeof Object.getOwnPropertySymbols && (z = z.concat(Object.getOwnPropertySymbols(m).filter(function(c) { return Object.getOwnPropertyDescriptor(m, c).enumerable }))), z.forEach(function(c) {
                    var z, h, v;
                    z = l, v = m[h = c], h in z ? Object.defineProperty(z, h, { value: v, enumerable: !0, configurable: !0, writable: !0 }) : z[h] = v
                })
            }
            return l
